...
return "App '$appname' has been killed off from the Start menu"
}else{
...
Write-Error "I'm having trouble killin that! (App-Name correct?)"
}
}
...
Pin-App "news" -unpin
Pin-App "skype" -unpin
Pin-App "fitbit coach" -unpin
Pin-App "microsoft store" -unpin
Pin-App "phototastic collage" -unpin
